...
TEST(intervals02, test) {
  ...
  OPTBACKEND::intervals02 intervals02_gt(dom, in, out_gt);
  cxxnaive::intervals02 intervals02_naive(dom, in, out_naive);

  intervals02_gt.run(in, out_gt);
  intervals02_naive.run(in, out_naive);
