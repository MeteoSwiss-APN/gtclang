...
#include "test/integration-test/CodeGen/generated/lap_c++-naive.cpp"
...
// clang-format off
#include INCLUDE_FILE(test/integration-test/CodeGen/generated/lap_,OPTBACKEND.cpp)
// clang-format on
...
TEST(lap, test) {
  ...
  OPTBACKEND::lap_stencil lap_gt(dom, in, out_gt);
  cxxnaive::lap_stencil lap_naive(dom, in, out_naive);
