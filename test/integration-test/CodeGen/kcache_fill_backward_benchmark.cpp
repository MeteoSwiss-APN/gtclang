...
// clang-format off
#include INCLUDE_FILE(test/integration-test/CodeGen/generated/kcache_fill_backward_,OPTBACKEND.cpp)
// clang-format on

using namespace dawn;
TEST(kcache_fill_backward, test) {
  ...
  OPTBACKEND::kcache_fill_backward kcache_fill_backward_gt(dom, in, out_gt);
  cxxnaive::kcache_fill_backward kcache_fill_backward_naive(dom, in, out_naive);

  kcache_fill_backward_gt.run(in, out_gt);
  kcache_fill_backward_naive.run(in, out_naive);
