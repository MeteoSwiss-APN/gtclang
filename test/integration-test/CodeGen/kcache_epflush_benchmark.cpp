...
#include "test/integration-test/CodeGen/generated/kcache_epflush_c++-naive.cpp"
...
// clang-format off
#include INCLUDE_FILE(test/integration-test/CodeGen/generated/kcache_epflush_,OPTBACKEND.cpp)
// clang-format on

using namespace dawn;
TEST(kcache_epflush, test) {
